...
cipher_add
*/
void paillier_cipheradd(int n, int L, paillier_pubkey_t* pub, paillier_ciphertext_t et[], paillier_ciphertext_t S[]);


/*
parallel paillier_enc
*/
void paillier_para_enc(int n, paillier_pubkey_t* pub, paillier_plaintext_t SS[], paillier_ciphertext_t S[]);

/*
parallel paillier dec
*/
void paillier_para_dec(int n, paillier_pubkey_t* pub, paillier_prvkey_t* prv, paillier_ciphertext_t S[], paillier_plaintext_t SS[]);
